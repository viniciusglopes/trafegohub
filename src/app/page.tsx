...
function LandingPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-950">
      <nav className="border-b border-slate-200/50 dark:border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="#planos"
                className="text-sm text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-gray-100 transition-colors hidden sm:block"
              >
                Planos
              </Link>
              <Link
                href="/login"
                className="text-sm text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-gray-100 transition-colors"
              >
                Entrar
              </Link>
              <Link
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-gray-100 tracking-tight leading-tight">
              Gerencie todo seu trafego pago em um{" "}
              <span className="text-blue-500">so lugar</span>
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-slate-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="#planos"
                className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 border border-slate-300 dark:border-gray-700 hover:border-slate-400 dark:hover:border-gray-600 text-slate-700 dark:text-gray-300 hover:text-slate-900 dark:hover:text-gray-100 font-medium rounded-xl transition-colors text-base"
              >
                Ver Planos
              </Link>
            </div>
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-slate-500 dark:text-gray-400 text-lg max-w-2xl mx-auto">
      ...
      <section id="planos" className="py-20 sm:py-28 bg-slate-100/50 dark:bg-gray-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {plans.map((plan) => (
              <div
                key={plan.name}
                className={`relative bg-white dark:bg-gray-900 border rounded-2xl p-6 flex flex-col ${
                  plan.popular
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-600/10 via-blue-600/5 to-transparent border border-slate-200 dark:border-gray-800 rounded-2xl p-8 sm:p-12 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              <Shield className="w-6 h-6 text-blue-500" />
              <Bell className="w-6 h-6 text-blue-500" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-gray-100 mb-4">
      ...
      <footer className="border-t border-slate-200/50 dark:border-gray-800/50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <Link
                href="/termos"
                className="text-sm text-slate-400 dark:text-gray-500 hover:text-slate-500 dark:hover:text-gray-400 transition-colors"
              >
                Termos
              </Link>
              <Link
